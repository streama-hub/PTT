...
@pytest.mark.parametrize("release_name, expected_audio", [
    ...
    ("Detroit.2017.BDRip.MD.GERMAN.x264-SPECTRE", []),
...
@pytest.mark.parametrize("release_name, expected_audio", [
    ("Macross ~ Do You Remember Love (1984) (BDRip 1920x1036p x265 HEVC DTS-HD MA, FLAC, AC3x2 5.1+2.0x3)(Dual Audio)[sxales].mkv", ['FLAC', 'Dolby Digital', 'DTS-HD MA']),
...
@pytest.mark.parametrize("release_name, expected_audio, expected_title", [
    ...
    ("Oppenheimer.2023.2160p.MA.WEB-DL.DUAL.DTS.HD.MA.5.1+DD+5.1.DV-HDR.H.265-TheBiscuitMan.mkv", ['Dolby Digital Plus', 'DTS-HD MA'], "Oppenheimer"),
    ...
    ("Sleepy.Hollow.1999.BluRay.1080p.2Audio.DTS-HD.HR.5.1.x265.10bit-ALT", ['DTS-HD HRA'], "Sleepy Hollow"),
    ...
    ("Big.Stan.2007.1080p.BluRay.Remux.DTS-HD.HR.5.1", ['DTS-HD HRA'], "Big Stan"),
    ("Ditched.2022.1080p.Bluray.DTS-HD.HR.5.1.X264-EVO[TGx]", ['DTS-HD HRA'], "Ditched"),
    ("Basic.Instinct.1992.Unrated.Directors.Cut.Bluray.1080p.DTS-HD-HR-6.1.x264-Grym@BTNET", ['DTS-HD HRA'], "Basic Instinct"),
])
